...
[State -1, Mugen Tsukuyomi Falso]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = numhelper(1565) = 1
triggerall = var(5) = 1
Triggerall = power >= 2000
value = 590
triggerall = command = "holddown"
...
Triggerall = var(5) = 1
Triggerall = power >= 1000
value = ifelse(statetype = A,14180,14100)
...
triggerall = numhelper(3890) = 0
triggerall = var(5) = 1
Triggerall = power >= 1000
value = ifelse(statetype = A,3870,3800)

...
type = ChangeState
Triggerall = numhelper(854) = 0
Triggerall = numhelper(855) = 0
Triggerall = numhelper(8551) = 0
...
[State -1, Kubikiri Houchou Shuriken]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(3050) = 0
Triggerall = power >= 1000

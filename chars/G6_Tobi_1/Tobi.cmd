...
[State -1, Transformation Mode]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(34100) = 0
Triggerall = var(2) = 0
value = 8080
trigger1 = command = "s"
trigger1 = statetype != A
...
[State -1, Transformation Mode Fin]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = var(2) = 1
value = 554

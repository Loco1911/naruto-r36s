...
Triggerall = power >= 1000
value = 29010
triggerall = command = "Kawarami no Jutsu"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
[State -1, Kawarami Restart Bloqueado]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = power >= 1000
value = 590
triggerall = command = "Kagura Mode"
triggerall = statetype != A
trigger1 = ctrl
trigger1 = numhelper(25100) = 0
trigger2 = numhelper(700) > 0


[State -1, Kawarami Restart]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(1550) = 0
Triggerall = power >= 1000

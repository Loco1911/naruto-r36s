...
[command]
name = "Mokuton Floor Woods"
command = ~D,DB,B,c
time = 15

[command]
name = "Mokuton Bushin Shuu"
command = ~D,DF,F,c
time = 15

[command]
name = "Mokuton Mokujou Heki"
command = ~D,DB,B,b
time = 15
...
[command]
name = "Mokuton Bunshin no Jutsu"
command = ~D,DB,B,a
time = 15

[command]
name = "Suiton Hanonryuu"
command = ~D,DF,F,a
time = 15
...
[State -1, Mokuton Yukai Koutan]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(524) = 0
Triggerall = numhelper(519) = 0
Triggerall = power >= 2000
value = 523
triggerall = command = "holddown"
...
[State -1, Giant Suiton Hanonryuu]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 1
...
[State -1, Mokuton Floor Woods]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(514) = 0
Triggerall = numhelper(519) = 0
Triggerall = power >= 1000
value = 513
...
[State -1, Mokuton Mokujou Heki]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(517) = 0
Triggerall = power >= 1000
value = 516

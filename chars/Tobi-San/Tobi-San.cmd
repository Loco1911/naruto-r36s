...
;---------------------------------------------------------------------------
;Ground Geyser
[State -1, Ground Geyser]
type = ChangeState
value = 650
triggerall = command = "Ground Geyser"
trigger1 = power >= 1000
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------
;Douton Dragon
[State -1, Douton Dragon]
type = ChangeState
value = 660
triggerall = command = "Douton Dragon"
trigger1 = power >= 2000
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------
...
type = ChangeState
value = 440
triggerall = command = "Coin Pickup"
trigger1 = power >= 1000
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------
;Deidara Summon
[State -1, Deidara Summon]
type = ChangeState
value = 600
triggerall = command = "Deidara Summon"
trigger1 = power >= 3000
trigger1 = statetype = S
trigger1 = ctrl
;---------------------------------------------------------------------------

...
type = ChangeState
triggerall = stateno != 60 && stateno != 2060
triggerall = stateno != 70 && stateno != 2070
value = ifelse(var(5) = 1,2060,60)
trigger1 = command = "FF"
trigger1 = ifelse(var(2) = 1,statetype = S,statetype != C)
trigger1 = ctrl
...
triggerall = command = "Chodan Bakugeki"
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
[State -1, Akimichi Pill]
type = ChangeState
Triggerall = var(2) = 0
Triggerall = power >= 1000
value = 1300
triggerall = command = "Akimichi Pill"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Chodan Bakugeki]
type = ChangeState
Triggerall = life < lifemax /1
Triggerall = var(2) = 0
Triggerall = power >= 1000
value = 1400
triggerall = command = "Nikudan Sensha"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1500
triggerall = command = "Nikudan Jusensha"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0

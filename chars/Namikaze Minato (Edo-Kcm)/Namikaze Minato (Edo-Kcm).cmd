...
[State -1, Shuriken Kage Bushin no Jutsu]
type = ChangeState
...
[State -1, Hisho Gekkorin Rasen Shippu Zeroshiki]
type = ChangeState
Triggerall = power >= 500
...
[State -1, Celestail Air Slice Type-Zero]
type = ChangeState
...
[State -1, Kurama's triple tail attack]
type = ChangeState
Triggerall = power >= 1000
...
[State -1, Rasen senko cho ribuko sanshiki]
type = ChangeState

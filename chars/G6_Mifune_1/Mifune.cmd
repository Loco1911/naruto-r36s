...
[State -1, Flying Swallow Thrust]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = power >= 1000
value = 1000
triggerall = command = "Flying Swallow Thrust"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1300
triggerall = command = "Trench Knife Throw"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1500
triggerall = command = "Katon Hiuchi Yagura"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0

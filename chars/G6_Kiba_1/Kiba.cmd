...
Triggerall = power >= 1000
value = 1200
triggerall = command = "Animal Mode"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Akamaru Pills]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = helper(4000),stateno = 4000 || helper(4000),stateno = 4020
Triggerall = var(5) = 0
Triggerall = power >= 1000
value = 1300
triggerall = command = "Akamaru Pills"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1400
triggerall = command = "Smoke Rendan"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
[State -1, Cancel]
...
[State -1, Smoke Rendan]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = helper(4000),stateno = 4000 || helper(4000),stateno = 4020
Triggerall = power >= 1000
value = 1500
triggerall = command = "Trap Dog"
trigger1 = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0

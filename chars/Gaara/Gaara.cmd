...
Triggerall = numhelper(1271) = 0
triggerall = statetype != A
value = 1200
triggerall = command = "Suna Ball"
trigger1 = ctrl
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Endan Suna Shigure
[State -1, Endan Suna Shigure]
type = ChangeState
triggerall = numhelper(1350) = 0
Triggerall = power >= 1000
value = 1300
triggerall = command = "Endan Suna Shigure"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
...
value = 1400
triggerall = command = "Sabaku Kyu"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
;---------------------------------------------------------------------------
; Gokusamaisou
[State -1, Gokusamaisou]
type = ChangeState

...
Triggerall = power >= 500
value = 1100
triggerall = command = "Asalto Bijuu"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1300
triggerall = command = "Counter Rap"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1400
triggerall = command = "Samehada"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Combo 9 swords]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = var(2) = 0 && var(3) = 0 && var(4) = 0
Triggerall = power >= 1000
value = 1500
triggerall = command = "Combo 9 swords"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0

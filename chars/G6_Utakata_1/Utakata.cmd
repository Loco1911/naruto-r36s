...
[command]
name = "Suiton Pistol Gun"
command = ~D,DF,F,b
time = 15

[command]
name = "Counter Explosive"
command = ~D,DB,B,b
time = 15

[command]
name = "Suiton Santouka"
command = ~D,DF,F,c
time = 15
...
[State -1, Suiton Chou Houmatsu no Jutsu]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
...
triggerall = command = "Suiton Houmatsu no Jutsu"
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
[State -1, Suiton Houmatsurou no Jutsu]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = numhelper(1250) = 0
Triggerall = power >= 500
value = 1200
triggerall = command = "Suiton Pistol Gun"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Explosive Houmatsurou no Jutsu]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = power >= 1000
value = 1300
triggerall = command = "Counter Explosive"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Suiton Santouka]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(1450) = 0
Triggerall = power >= 1000
value = 1400
triggerall = command = "Suiton Santouka"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Houmatsurou Mode]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = var(4) = 0
Triggerall = numhelper(1550) = 0
Triggerall = power >= 1000
value = 1500
triggerall = command = "Gokusamaisou"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0

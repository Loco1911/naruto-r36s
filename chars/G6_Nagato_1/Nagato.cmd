...
triggerall = command = "Shura no Ko"
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1100
triggerall = command = "Kyukon no Jutsu"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Shura Missiles]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = numhelper(1250) = 0
Triggerall = power >= 1000
value = 1200
triggerall = command = "Shura Missiles"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0

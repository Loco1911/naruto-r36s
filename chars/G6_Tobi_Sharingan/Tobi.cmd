...
[command]
name = "Dai Kibaku Dama"
command = ~D,DF,F,a
time = 15

[command]
name = "Mogura Tatakai no Jutsu 1"
command = ~D,DB,B,a
time = 15
...
[command]
name = "Mogura Tatakai no Jutsu 2"
command = ~D,DB,B,c
time = 15
...
Triggerall = power >= 1000
value = 1000
triggerall = command = "Dai Kibaku Dama"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = numhelper(17090) = 0
Triggerall = power >= 1000
value = ifelse(statetype = A,17080,17000)
triggerall = command = "Dai Kibaku Dama"
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Mogura Tatakai no Jutsu 1]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 0
Triggerall = power >= 1000
value = 1100
triggerall = command = "Mogura Tatakai no Jutsu 1"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Kamui Assault]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 1
Triggerall = power >= 1000
...
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 0
Triggerall = numhelper(1250) <= 2
Triggerall = power >= 500
value = 1200
triggerall = command = "Bomb Throw"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 1000
value = 1300
triggerall = command = "Kamui Protection"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Tenchi Bakusou]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 0
Triggerall = power >= 1000
value = 1400
triggerall = command = "Tenchi Bakusou"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0
...
Triggerall = power >= 500
value = 17400
triggerall = command = "Mogura Tatakai no Jutsu 2"
triggerall = statetype != A
trigger1 = ctrl
trigger2 = numhelper(700) > 0


[State -1, Mogura Tatakai no Jutsu 2]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 0
Triggerall = power >= 1000

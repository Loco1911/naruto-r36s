...
[State -1, Shugohakke Rokujuu Yonshou]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
...
Triggerall = power >= 1000
value = ifelse(statetype = A,509,505)
...
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = power >= 1000
value = ifelse(statetype = A,518,515)

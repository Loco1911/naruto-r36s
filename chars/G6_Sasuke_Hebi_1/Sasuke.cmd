...
Triggerall = numhelper(6116) = 0
Triggerall = numhelper(6120) = 0
value = 3200
triggerall = command = "holddown"
...
[State -1, Kirin Remate]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
Triggerall = numhelper(6120) = 1
...
[State -1, Katon Gokakyu no Jutsu Awakening]
type = ChangeState
triggerall = !NumPartner || NumPartner && (sysvar(4) != [8,9]) && (sysvar(4) != 12) && (StateNo != [1251109,1251114])
triggerall = var(2) = 1
Triggerall = numhelper(1150) = 0
